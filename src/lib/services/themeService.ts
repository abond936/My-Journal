...
`;
  ...
  --reader-story-feed-title-font-size: calc(${getThemeRecipeRefValue(themeData, recipes.typography.storyTitle.size)} * 1.08);
  ...
  --reader-gallery-feed-title-font-size: calc(${getThemeRecipeRefValue(themeData, recipes.typography.galleryTitle.size)} * 1.08);
  ...
  --reader-card-badge-compact-font-size: var(--reader-chrome-meta-font-size);
  --reader-card-badge-compact-line-height: 1.05;

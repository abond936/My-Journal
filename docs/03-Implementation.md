...
**Gaps / slices** — Reconcile delete, duplicate, publication, card, Gallery, tag, subject, inheritance, caption, and visible-media results across feed and detail; verify contextual return and failure retention; and complete browser verification of the full editor at mobile width.

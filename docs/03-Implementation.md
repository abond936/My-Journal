...
**Gaps / slices** — Complete representative browser verification, including safe Compose save-state and failure checks; continue aligning field validation or actionable errors found during those workflows; verify long-running progress in representative Administration and Reader operations.

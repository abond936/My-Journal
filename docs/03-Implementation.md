...
**Gaps / slices** — Complete browser activation of the shared delete confirmation and resulting contextual return; reconcile publication, Gallery, tag, subject, inheritance, caption, and visible-media results across feed and detail; verify remaining failure retention; and complete browser verification of the full editor at mobile width.

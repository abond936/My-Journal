...
- **Desktop feed rhythm verification checklist (2026-05-31)** - **Closed 2026-07-10** with square uniform feed tiles: main feed grid rows align at one square height for `Story`/`Gallery`/`Question`/`Quote`; meta bands align across types; `Callout` remains the portrait utility outlier. Residual follow-up: cover-editor secondary-surface feed preview, compact rail chip omission policy.
